        ...
        return (
            <>
                ...
                <form onSubmit={onSubmit} className="flex flex-col gap-5">
                    ...
                    <h1 className="text-opacity-60 font-semibold text-black text-center">Don't have an account? <a className="hover:underline text-opacity-100 text-black cursor-pointer" onClick={() => setRegister(true)}>Sign Up!</a></h1>
                </form>
            </>
        )
    }
        ...
        return (
            <>
                ...
                <form onSubmit={onSubmit} className="flex flex-col gap-5">
                    ...
                    <h1 className="text-opacity-60 font-semibold text-black text-center">Already have an account? <a className="hover:underline text-opacity-100 text-black cursor-pointer" onClick={() => setRegister(false)}>Login!</a></h1>
                </form>
            </>
        )
    }
